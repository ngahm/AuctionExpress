    ...
    public partial class InitialMigration : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.User", t => t.BidderId, cascadeDelete: false)
                .Index(t => t.ProductId)
                .Index(t => t.BidderId);
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        ProductSeller = c.Int(nullable: false),
                    })
                ...
                .ForeignKey("dbo.User", t => t.ProductSeller, cascadeDelete: false)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Bid", "BidderId", "dbo.User");
            DropForeignKey("dbo.Bid", "ProductId", "dbo.Product");
            DropForeignKey("dbo.Product", "ProductSeller", "dbo.User");
